...
const suspects = ["Mr. Green","Mrs. Peacock","Prof. Plum","Mrs. White","Miss Scarlett","Col. Mustard"]
...
const b = _.transform({a:1,b:2},function(result,value) {
	result.push(value);
},[]);

const summary = _.transform(gameData,(accumulator,key)=> {
	if(cluesSoFar[key]) {
